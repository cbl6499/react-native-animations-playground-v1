...
/**
 * This is mainly used to show a splash screen for the duration it takes to load all the assets.
 * Another nice features is, that in development it saves the current navigation state.
 */
